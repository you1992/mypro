            ...
            [
                 {
                    ...
                    [
                        ...
                        {"icon":"icon-sys","menuid":"102","menuname":"商品家务事","url":"goods.html"}                        
                    ]
                 },
                 {
                     "icon":"icon-sys","menuid":"200","menuname":"人事管理","menus":
                    [
                        {"icon":"icon-sys","menuid":"201","menuname":"部门","url":"dep.html"}    ,
                        {"icon":"icon-sys","menuid":"202","menuname":"员工","url":"emp.html"}                        
                    ]
                 }
        ...
        buttons:[
             {
                 ...
                 handler:function(){
                    ...
                    var submitData = $('#updatePwdForm').serializeJSON();
                    $.ajax({
