...
<head>
    ...
    <script>
        var skuList=[
            <#list skuList as sku>
                <#if skuList?size-1==sku_index>
                    {"id":${sku.id?c},"title":"${sku.title}","price":${sku.price?c},spec:${sku.spec}}
                <#else >
                    {"id":${sku.id?c},"title":"${sku.title}","price":${sku.price?c},spec:${sku.spec}},
                </#if>
            </#list>
            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom">
                            <img jqimg="${itemImages[0].url}" src="${itemImages[0].url}" width="400px" height="400px"/>
                        </span>
                    </div>
                    <!--下方的缩略图-->
                        ...
                        <#list specificationItems as specification>
                            <dl>
                                ...
                                <#list specification.attributeValue as item>
                                    ...
                                    <dd><a href="javascript:;" ng-click="selectSpecification('${specification.attributeName}','${item}')" class="{{isSelected('${specification.attributeName}','${item}')?'selected':''}}">${item}<span title="点击取消选择">&nbsp;</span></a></dd>
                                </#list>
                    ...
                    <div class="summary-wrap">
                        <div class="fl title">
                            <div class="control-group">
                                <div class="controls">
                                    <input autocomplete="off" type="text" value="{{num}}" ng-model="num" minnum="1"  class="itxt"/>
